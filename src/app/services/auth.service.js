...
var AuthService = (function (_super) {
            ...
            if (response.result) {
                if (response.result.success) {
                    ...
                    if (response.result.userInfo) {
                        _super.prototype.setUserInfoData.call(_this, response.result.userInfo);
                    }
                    ...
                    _super.prototype.removeUserAuthData.call(_this);
    ...
    AuthService.prototype.logout = function () {
        _super.prototype.removeUserAuthData.call(this);
        this.router.navigate(['/login']);
    };
    AuthService.prototype.isLogin = function () {
        // console.log('로그인 체크 합니다.~');
        if (_super.prototype.getAuthInfo.call(this)) {
    ...
    AuthService.prototype.getUserInfo = function () {
        ...
        var userInfo = _super.prototype.getUserInfoData.call(this);
        if (userInfo) {
